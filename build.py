...
@media (max-width:720px){
  ...
  /* Lowell, 2026-08-04: the stat ledger is desktop-only. HIDDEN, not removed —
     #t-buy/#t-total/#t-gone/#t-brands/#t-updated are the weekly refresh's
     hydration contract and must stay in the DOM to be rewritten. Diverges from
     design's reference until they fold it in; raised on the RELAY thread. */
